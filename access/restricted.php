...
//    }
    ...
    public function OptionsREMOVEPage() {
        $settings = get_option( 'registered-users-only' );
        ?>
...
function fs_register_users_only() {
    global $fs_register_users_only;

    $fs_register_users_only = new fs_register_users_only();
}
